...
ratingMethod();
 ...
 if(widget.product.rating!.isNotEmpty){
   for(int i =0;i<widget.product.rating!.length; i++){
    ...
    if(totalRating!=0){
      avrRating=totalRating/widget.product.rating!.length;
      setState(() {
              ...
              CarouselSlider(
                items: widget.product.images.map((e) {
                 ...
                 Padding(
                  ...
                  'Deal Price: ',style:  const TextStyle(fontSize: 16,
                  color: Colors.black,
                  fontWeight: FontWeight.bold),
                  children: [
                    TextSpan(text:
                  '\$${widget.product.price} ',style:  const TextStyle(fontSize: 22,
                  color: Colors.red,
                  fontWeight: FontWeight.w500))
                  ])),
                ...
                Padding(
                   padding: const EdgeInsets.all(10),
                   child: CustomButton(text: 'Add to cart',color: const Color.fromRGBO(254, 216, 19, 1), onTap: addToCart,
                 ),),
                  const  SizedBox(height: 10,),
                  Container(
                  color: Colors.black12,
                  ...
                  const Padding(
                   ...
                   child: Text('Rate The Product',style: TextStyle(fontSize: 22,
                   fontWeight: FontWeight.bold),)),
                   RatingBar.builder(
                   ...
                   avrRating=await  productDetailsServices.rateProduct(context: context, product: widget.product, rating: rating,);
