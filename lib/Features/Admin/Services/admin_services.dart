...
class AdminServices {
  void sellProduct({
    ...
    try {
      final cloudinary = CloudinaryPublic('do4a9r6py', 'ue90gvnx');
 ...
 void changeOrderStatus({required BuildContext context,
  ...
  required VoidCallback onSuccess
    ...
    final userProvider= Provider.of<UserProvider>(context,listen: false);
    try{
      http.Response res  = await http.post(Uri.parse('$uri/admin/change-order-status'),headers: {
        'Content-Type': 'application/json; charset=UTF-8',
        'x-auth-token':userProvider.user.token,
      },
      body: jsonEncode({
      ...
      httpErrorHandler(
        ...
        onSuccess: () {
          ...
          sales=[
            ...
            Sales('Fashions', response['fashionEarnings']),
